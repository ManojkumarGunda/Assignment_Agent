      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-6 relative">
        ...
        <div className="w-full rounded-[40px] bg-white p-8 sm:p-10 lg:p-12 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1">
              <label htmlFor="password" className="text-[10px] font-black text-gray-400 uppercase tracking-[4px] ml-1">Key Phrase</label>
              <input
                id="password"
                name="password"
                type="password"
            ...
            <div className="space-y-1">
              <label htmlFor="confirmPassword" className="text-[10px] font-black text-gray-400 uppercase tracking-[4px] ml-1">Verify Key</label>
              <input
                id="confirmPassword"
