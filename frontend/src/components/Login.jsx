          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                <label htmlFor="password" className="text-[10px] font-black text-gray-400 uppercase tracking-[4px]">Key Phrase</label>
                <button type="button" className="text-[9px] font-black text-[#00A896] uppercase tracking-[2px] hover:text-[#020617] transition-colors">Reset Key</button>
              </div>
              <input
                id="password"
                name="password"
